...
module ascon_top_tb import ascon_pack::*; ();
	...
	initial begin : main
		...
		// Key and nonce are available at t = 0, static and dont change ever
		...
		// Reset phase: resetb_i is active low (le reset est actif a l'état bas)
		resetb_s   = 1'b0;
		start_s = 1'b0;
		data_valid_s = 1'b0;
		data_s = 64'h0;
		...
		data_valid_s = 1'b1;
		#20;
		data_valid_s = 1'b0; // on considere que le flag data valid est valable pdt ce temps eonly (20)
